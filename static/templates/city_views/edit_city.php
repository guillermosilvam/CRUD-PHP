<?php include "../../../app/controllers/city_controllers/edit_city.php" ?>
<?php include "../../../app/includes/navbar.php" ?>
        <div class="w-full h-full flex items-center justify-center">
            <div class="w-full max-w-md mx-auto p-8 bg-white rounded-lg shadow-lg border border-gray-200">
                <form class="space-y-6" action="/server/app/controllers/city_controllers/edit_city.php?id=<?php echo $_GET['id'];?>" method="POST">
                    <div class="space-y-2"> 
