...
<div class="w-full h-full flex items-center justify-center">
            <div class="w-full max-w-md mx-auto p-8 bg-white rounded-lg shadow-lg border border-gray-200">
                <form class="space-y-6" action="/server/app/controllers/trip_controllers/post_trip.php" method="POST">
                    <div class="space-y-2"> 
                        ...
                        <select name="tren_id" required class="w-full px-4 py-2 rounded-md bg-gray-100 border border-gray-300 text-gray-800 focus:outline-none focus:bg-white focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition duration-200">
                            ...
                            <?php while($tren = mysqli_fetch_assoc($trenes)): ?>
                                <option value="<?php echo $tren['codigo']; ?>">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="date" name="fecha" required class="w-full px-4 py-2 rounded-md bg-gray-100 border border-gray-300 text-gray-800 focus:outline-none focus:bg-white focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition duration-200"/>
                    </div>
                    <div class="space-y-2">
                        <label for="hora" class="block text-sm font-medium text-gray-700">Hora</label>
                        <input type="time" name="hora" required class="w-full px-4 py-2 rounded-md bg-gray-100 border border-gray-300 text-gray-800 focus:outline-none focus:bg-white focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition duration-200"/>
                    </div>
